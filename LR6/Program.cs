...
namespace LR3   
{
    ...
    abstract class Sportsman : Human, IComparable
    {
        ...
        {
            Sportsman subject = s as Sportsman;
            if (subject != null)
                return this.category.CompareTo(subject.category);
    ...
    sealed class Footballer : Sportsman, IComparable
    {
        ...
        {
            Console.WriteLine("The doping test has been passed. You are admitted to the tournament");
        }
    }
    sealed class Athlete : Sportsman, ICompetable
    {
        ...
        public void Compete()
        {
            ...
            {
                Console.WriteLine($"Congraulations! You have set a new record: {distance} meters!");
                record = distance;
                place = 1;
            }
            else
        ...
        public void DopingTest()
        {
            Console.WriteLine("The doping test has been passed. You are eligible to compete in athletics");
        }
    }
    sealed class Weightlifter : Sportsman, ICompetable
    {
        private int weight;
        ...
        public void Compete()
        {
            ...
            {
                Console.WriteLine($"Congraulations! You have set a new record: {totalWeight} kg!");
                record = totalWeight;
                place = 1;
            }
            else
        ...
        public void DopingTest()
        {
            Console.WriteLine("The doping test has been passed. You are eligible to compete in weightlifting");
        }
    }
}
